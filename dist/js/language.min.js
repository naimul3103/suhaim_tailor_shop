...
function getTranslation(e) {
  return translations[currentLang][e] || translations.en[e] || e;
}
function changeLanguage(e) {
  (currentLang = e),
    document.body.setAttribute("data-lang", e),
    (document.body.dir = "ar" === e ? "rtl" : "ltr"),
    localStorage.setItem("preferredLanguage", e),
    (document.getElementById("languageSelect").value = e),
    updatePageLanguage();
}
function updatePageLanguage() {
  document.querySelectorAll("[data-lang]").forEach((e) => {
    ...
    translations[currentLang][t] &&
      (e.textContent = translations[currentLang][t]);
  }),
    document.querySelectorAll("[placeholder]").forEach((e) => {
      const t = e.getAttribute("data-placeholder-key");
      t &&
        translations[currentLang][t] &&
        (e.placeholder = translations[currentLang][t]);
    }),
    document.querySelectorAll("select option[data-lang]").forEach((e) => {
      const t = e.getAttribute("data-lang");
      translations[currentLang][t] &&
        (e.textContent = translations[currentLang][t]);
    });
